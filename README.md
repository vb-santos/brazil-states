...
<p align="justify">
  - Projeto desenvolvido para uma atividade durante meu período letivo do ensino médio, nesta atividade deveriamos criar um sistema em javascript que criasse uma lista e exibisse separadamente nas páginas os estados referentes a cada região do país, gerando o conteúdo das páginas através destas listas.
</p>
<br>

- Listas em JavaScript;
- Gerar conteúdo da página com JavaScript;
...
<p width="100%" align="center">
  <a href="https://vb-santos.github.io/brazil-states/" target="_blank"><img src="https://img.shields.io/badge/Preview-FF5722?style=for-the-badge&logo=todoist&logoColor=white" width="30%"></a>
</p>
